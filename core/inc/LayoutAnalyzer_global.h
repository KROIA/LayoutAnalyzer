...
#include <chrono>
// Params
// <LIBRARY NAME SHORT>=LA 
//
#ifndef BUILD_STATIC
	//#pragma message("LAYOUTANALYZER_LIB is a shared library")
	#if defined(LAYOUTANALYZER_LIB)
		#define LAYOUT_ANALYZER_EXPORT __declspec(dllexport)
	#else
		#define LAYOUT_ANALYZER_EXPORT __declspec(dllimport)
	#endif
#else 
	//#pragma message("LAYOUTANALYZER_LIB is a static library")
	#define LAYOUT_ANALYZER_EXPORT
#endif
