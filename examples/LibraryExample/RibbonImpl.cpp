	...
	: RibbonWidget::Ribbon(parent)
{
	...
	// Create groups
	RibbonWidget::RibbonButtonGroup* inputGroup	= new RibbonWidget::RibbonButtonGroup("Inputs", tabSettings);
	...
	// Create buttons
	m_inputButtons.loadLayer = new RibbonWidget::RibbonButton("Load Layer", "Load a layer image", ":/icons/live_folder_2.png", true, inputGroup);
	m_inputButtons.loadMask = new RibbonWidget::RibbonButton("Load Mask", "Load a mask image representig a via,\nused for via detection", ":/icons/live_folder_2.png", true, inputGroup);
